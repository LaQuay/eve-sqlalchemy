...
Keep in mind that every browser or cURL generator can implement its own encoder, and not all produces the same result. So, adding --data-urlencode to the curl query should work.
